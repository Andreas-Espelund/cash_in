...
export default function ListView({invoice, number}) {
    ...
    <tr className="relative">
        ...
        <td className="p-4 hidden lg:block">
            <button onClick={() =>exportPDF(invoice.number, invoice.number)} className="flex items-center gap-1 select-none m-auto border-b-2 border-secondary  hover:scale-[108%] active:scale-95 transition-all text-secondary font-semibold">
